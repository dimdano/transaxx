...
def get_model_complexity_info(model, input_res,
    ...
    if backend == 'pytorch':
        flops_count, params_count, layer_specs = get_flops_pytorch(model, input_res,
    ...
    if as_strings:
        ...
        return flops_string, params_string, layer_specs

    
    return flops_count, params_count, layer_specs
