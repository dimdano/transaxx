...
#import _adaptconv_ext._transposed_adapt_convolution as transposed_adapt_conv
from .layer_utils import _pair


class TransposedAdaptConvolutionFunction(torch.autograd.Function):
    ...
    def forward(self, input, weight, bias, kernel_size, stride, padding,
        ...
        return transposed_adapt_conv.transposed_adapt_conv_forward(
    ...
    def backward(self, grad_output):
        ...
        grad_input, grad_weight, grad_bias = transposed_adapt_conv.transposed_adapt_conv_backward(
...
class TransposedAdaptConvolution(nn.Module):
    ...
    def __init__(
        ...
        super(TransposedAdaptConvolution, self).__init__()
    ...
    def forward(self, x):
        return TransposedAdaptConvolutionFunction.apply(
